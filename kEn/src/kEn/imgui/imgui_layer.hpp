 ...
 *     renderer backend (via ImguiBackend::create()).
...
class ImguiLayer final : public Layer {
 public:
  ...
  /** Initializes the ImGui context and renderer backend. */
  void on_attach() override;

  /** Shuts down the renderer backend and destroys the ImGui context. */
